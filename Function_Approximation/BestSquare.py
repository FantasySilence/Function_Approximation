...
class BestSquareApproximation:
    ...
    def cal_x0(self, x0):
        ...
        x0：所求逼近点的x坐标
        """
        from utils import best_approximation_utils
        return best_approximation_utils.cal_x0(self.approximation_poly, x0)
    ...
    def error_analysis(self):
        ...
        self.max_abs_error, self.mae = best_approximation_utils.error_analysis(params)
    ...
    def plt_approximation(self, is_show=True):
        ...
        best_approximation_utils.plt_approximation(params)
